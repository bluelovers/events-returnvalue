...
var e, t = require("events");

exports.EnumInternalEventName = void 0, (e = exports.EnumInternalEventName || (exports.EnumInternalEventName = {})).newListener = "newListener", 
e.removeListener = "removeListener", e.error = "error";

class EventEmitter extends t.EventEmitter {
  on(e, t) {
...
function _createCacheEvent(e, t) {
  ...
  null !== (a = (s = t).name) && void 0 !== a || (s.name = e), "returnValue" in t || (t.returnValue = void 0), 
  t;
}
...
exports.EventEmitter = EventEmitter, exports._createCacheEvent = _createCacheEvent, 
exports._emitArgv = _emitArgv, exports.default = EventEmitter;
